...
public class Ticket {
	/*Vamos a modelar nuestro objeto de respuesta cuando las operaciones del cajero
	 * sean satisfactorias
	 * 
	 * PLANTILLA PARA CREAR OBJETOS TICKET - Se van a emitir/ crear solo cuando se 
	 * llevan a cabo las operaciones CORRECTAMENTE (se emite un ticket 
