...
public class Condicionales8_AMGC {

	public static void main(String[] args) {
		/* 8. Realiza un programa que pida por teclado el resultado (dato entero) obtenido al lanzar
		 * un dado de seis caras y muestre por pantalla el número en letras (dato cadena) de la cara opuesta
		...
		System.out.println("Por favor ingrese el resultado después de lanzar el dado:");
