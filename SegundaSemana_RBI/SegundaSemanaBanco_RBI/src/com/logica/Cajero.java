...
public class Cajero implements IMetodos {
	...
	//En este paquete se encuentra contenida la clase que 
	//creara los objetos que realizaran las operaciones
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		if(consultar(numeroCuenta) !=null) {
			...
			//vamos a crear un ejemplo de que el cajero solo permite retirar cierta cantidad
			
			if (monto>9000) {
				System.out.println("El monto excede el limitie diario");
				return ticket;
				...
				return ticket;
			}else {//Si el retiro puede realizarse, acutualizamos el saldo de la cuenta
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		//Validamos si el monto a depositar es mayor que el saldo maximo que permite la cuenta
			if(monto>cuenta.getSaldoMax()) {
				...
				System.out.println("El saldo excederia el maximo permitido en l acuenta");
				return ticket;
