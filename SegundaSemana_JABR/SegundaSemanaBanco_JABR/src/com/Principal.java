...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//de dos formas
		//Primero creando la cuenta y agregandola después
		Cuenta ana = new Cuenta("Ana", 15000, 1000, 25000, "Debito");
		
		//La agregamos al HashMap
		cuentas.put(1001, ana);
		
		//Otra forma de agregar cuentas al HashMap es creandolas directamente
		//en él
		...
		//Probando el método retirar, pero excediendo el limite del cajero
