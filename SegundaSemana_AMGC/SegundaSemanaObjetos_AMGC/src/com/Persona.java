...
public class Persona {
	...
	//Primero utilizaremos la abstracción para modelar los atributos de mi objeto aquí
	...
	/* Son métodos que nos van a permitir crear a nuestro objeto con sus valores ya iniciados
	 * o los que necesitemos iniciar.
	 * 
	 * Por lo general, contamos con el uso de dos constructores:}
	 */
	
	/* Contructor vacío: que nos permite instanciar nuestro objeto sin valores asignados
	 * Este se vuelve como un "dummie" o comodin, con el cual podremos asignar valores
	 * posteriormente con los métodos Setters
	 */
	public Persona() {
