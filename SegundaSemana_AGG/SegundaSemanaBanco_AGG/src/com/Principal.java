...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Probar el metodo consultar de nuestor cajero
		System.out.println(cajero1.consultar(1005));
				
		//probar el metodo retirar, pero excediendi el limite del cajero
		...
		//probando del metodo retirar dejando por debajo del minimo la cuenta
