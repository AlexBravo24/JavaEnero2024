...
public class Persona {
	...
	//retornar algún valor de un tipo de dato
	
	//Ejemplo, crear un metodo para que una persona pueda comer
	
	public void comer() 
	{//Aqui definimos la accion del mismo
	...
	//POLIMOFISMO EN METODOS, ES CUANDO TENEMOS VARIAS FORMAS DEL METODO
