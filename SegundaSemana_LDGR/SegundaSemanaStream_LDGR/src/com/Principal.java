...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// que nos va a permitir hacer un mejor uso de los datos de 
		// una colección.
		// En una colección podemos contar con muchos datos, y al 
		// ponerlos en un "flujo" (Stream), vamos a ser capaces de
		// solicitarlos o gestionarlos de la forma que mejor nos
		// convenga, ya sea filtrándolos, ordenándolos, etc.
...
//		alumnos.forEach(a -> System.out.println(a));
		...
		// Ejemplo de filtrar algún género con un ciclo convencional
//		for(Persona i: alumnos) {
...
//		filtrada.forEach(i -> System.out.println(i));
		...
		// .allMatch
		// .anyMatch
		// Optional<Persona> - La clase Optional lo que hace es tener la
