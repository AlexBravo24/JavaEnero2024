...
public class Cajero implements IMetodos { // implements es para interfaces
	...
	// En este paquete se encuentra contenida la clase que creará
	// los objetos que realizarán las operaciones
	...
	// Constructor con todos los parámetros (excepto folio)
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		Cuenta cuenta = null;
		// La cuenta que vamos a consultar está guardada en
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		if(consultar(numeroCuenta) !=null) {
			...
			// el saldo máximo que permite la cuenta
